        ...
        <div className="fixed inset-0 bg-slate-900/90 z-[100] overflow-y-auto flex justify-center p-0 md:p-4 backdrop-blur-sm">
            <div className="w-full max-w-5xl bg-white shadow-2xl flex flex-col relative min-h-screen md:min-h-0 md:rounded-2xl overflow-hidden">
                ...
                <div className="p-4 border-b flex justify-between items-center sticky top-0 bg-white/80 backdrop-blur-md z-[110] md:rounded-t-2xl">
                    <button onClick={onClose} aria-label="Close invoice preview" className="p-2 text-slate-500 hover:text-slate-800 bg-slate-100 rounded-full active:scale-90 transition-transform focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500">
                ...
                <div className="flex-1 overflow-auto p-4 md:p-12 bg-slate-100 flex flex-col gap-8">
                    {linePages.map((pageLines, pageIndex) => {
                        ...
                        return (
                            <div
                                key={pageIndex}
                                className="invoice-page bg-white text-black p-[15mm] w-[210mm] min-h-[297mm] font-sans text-[12px] leading-tight relative flex flex-col shrink-0 mx-auto"
                            ...
                            >
                                ...
                                {isFirstPage ? (
                                    <div className="text-center border-b-2 border-black pb-2 mb-2">
                                        ...
                                        <p className="m-0 font-medium text-[10px] text-slate-700">Tel: {settings.phone} | Email: vidushan.motors@gmail.com</p>
                                        <div className="text-[20px] font-bold underline mt-1 uppercase">INVOICE</div>
                                    </div>
                                ) : (
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        ...
                                        {isMultiPage && !isLastPage && (
                                            <tr className="font-black bg-slate-100 border-t border-black">
                                                ...
                                                <td className="py-1 px-2 text-right underline decoration-double">
                                ...
                                {isLastPage && (
                                    <div className="mt-auto pt-4">
                                        ...
                                        <div className="flex justify-between mt-6 mb-4">
                                            <div className="w-[30%] border-t border-black pt-1 text-center text-[10px] font-black uppercase">Customer Signature</div>
                                            <div className="w-[30%] border-t border-black pt-1 text-center text-[10px] font-black uppercase">Authorized Signature</div>
