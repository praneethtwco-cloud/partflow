                ...
                <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="hidden md:flex items-center gap-2 min-w-0">
                        <button
                            ...
                            className="text-white bg-rose-500 hover:bg-rose-600 p-1.5 rounded-full shrink-0 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500"
                        >
                    ...
                    <div className="flex items-center gap-2 md:gap-3 shrink-0">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button
                                ...
                                aria-label={useSuggestedInvoiceNumber ? "Using suggested invoice number" : "Use suggested invoice number"}
                                className={`p-1 rounded shrink-0 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500 ${useSuggestedInvoiceNumber ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-100 text-slate-500'}`}
                        ...
                        <div className="flex items-center gap-2">
                            <div className="relative flex-1">
                                ...
                                {catalogSearch && (
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500 rounded"
                                    >
                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg>
                                    </button>
                                )}
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    aria-label={showOutOfStock ? "Hide Out of Stock" : "Show Out of Stock"}
                                    className={`p-2.5 rounded-lg transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500 ${!showOutOfStock ? 'bg-rose-100 text-rose-600' : 'bg-slate-100 text-slate-600'}`}
                                ...
                                <button
                                    ...
                                    className={`p-2.5 rounded-lg transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500 ${filtersVisible ? 'bg-indigo-100 text-indigo-600' : 'bg-slate-100 text-slate-600'}`}
                                >
                                        ...
                                        <li key={line.line_id} className="p-3 flex justify-between items-start hover:bg-white transition-colors group bg-white border-b border-slate-100 last:border-0">
                                                ...
                                                <div className="flex items-center gap-2 mt-1.5">
                                                    <div className="flex items-center bg-slate-50 rounded-lg overflow-hidden border border-slate-200">
                                                        <button
                                                            ...
                                                            className={`px-2 py-0.5 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500 ${isEditingDisabled ? 'text-slate-300 cursor-not-allowed' : 'text-slate-600 hover:bg-slate-200 active:bg-slate-300'} transition-colors`}
                                            ...
                                            <div className="flex items-center gap-3 shrink-0">
                                                ...
                                                <button 
                                                    ...
                                                    className={`w-6 h-6 rounded-full focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500 ${isEditingDisabled ? 'bg-slate-100 text-slate-300 cursor-not-allowed' : 'bg-slate-50 text-slate-300 hover:bg-rose-100 hover:text-rose-500'} flex items-center justify-center transition-colors`}
                                                    disabled={isEditingDisabled}
                                                >
                ...
                <div className="fixed inset-0 z-[100] flex items-start md:items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4 pt-24 md:p-4 pb-safe">
                    <div className="bg-white w-full max-w-sm rounded-2xl p-6 shadow-2xl animate-in zoom-in-95 duration-200">
                        ...
                        <div className="flex items-center justify-center gap-4 mb-8">
                             <button onClick={() => setQtyInput(Math.max(1, parseInt(qtyInput)-1).toString())} aria-label="Decrease quantity" className="w-12 h-12 rounded-full bg-slate-100 text-2xl font-bold text-slate-600 hover:bg-slate-200 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500">-</button>
                            <input 
                                type="number" 
                                ...
                                autoFocus
                            />
                             <button onClick={() => setQtyInput((parseInt(qtyInput)+1).toString())} aria-label="Increase quantity" className="w-12 h-12 rounded-full bg-slate-100 text-2xl font-bold text-slate-600 hover:bg-slate-200 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500">+</button>
                        </div>
                ...
                <div className="fixed inset-0 z-[60] flex items-end md:items-center justify-center bg-slate-900/60 backdrop-blur-sm p-0 md:p-4">
                    <div className="bg-white w-full max-w-md rounded-t-3xl md:rounded-2xl p-6 pb-24 md:pb-6 shadow-2xl animate-in slide-in-from-bottom-10 fade-in duration-300 relative">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button onClick={() => setShowPaymentModal(false)} aria-label="Close payment modal" className="bg-slate-100 p-2 rounded-full text-slate-500 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-indigo-500">
