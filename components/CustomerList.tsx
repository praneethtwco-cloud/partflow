...
export const CustomerList: React.FC<CustomerListProps> = ({ onSelectCustomer, onOpenProfile }) => {
    ...
    const handleSaveCustomer = async () => {
        ...
        const customer: Customer = editingCustomer ? {
            ...
            outstanding_balance: editingCustomer.outstanding_balance,
                            ...
                            {!showAdminActions ? (
                                ...
                                <div className="grid grid-cols-2 gap-3 animate-in fade-in slide-in-from-top-2 duration-200">
                                    <button
                                        ...
                                        className={`flex items-center justify-center gap-2 py-3 rounded-xl font-bold border-2 transition-all ${actionCustomer.status === 'inactive'
