        ...
        <div className="space-y-6 pb-20 md:pb-0 px-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                <div
                    ...
                    className={`bg-gradient-to-br ${themeClasses.gradient} p-6 rounded-3xl shadow-lg ${themeClasses.shadow} text-white relative overflow-hidden group cursor-pointer active:scale-95 transition-transform`}
                >
                    ...
                    <p className={`text-xs uppercase font-bold text-white/80 tracking-wider mb-1`}>Today's Sales</p>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
                    ...
                    <p className="text-xs uppercase font-bold text-slate-400 tracking-wider mb-1 relative z-10">This Month</p>
                ...
                {settings.stock_tracking_enabled ? (
                    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm cursor-pointer hover:shadow-md transition-all group" onClick={() => onAction('inventory')}>
                    ...
                    <div className="bg-gradient-to-br from-emerald-500 to-emerald-700 p-6 rounded-3xl shadow-lg shadow-emerald-100 text-white relative overflow-hidden">
                        <p className="text-xs uppercase font-bold text-emerald-100 tracking-wider mb-1">System Status</p>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm cursor-pointer hover:shadow-md transition-all group" onClick={() => onAction('history')}>
                    <p className="text-xs uppercase font-bold text-slate-400 tracking-wider mb-1">Total Orders</p>
            ...
            <div>
                <h3 className="text-lg font-black text-slate-800 mb-3 sm:mb-4 px-1">Quick Actions</h3>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                    <button
                        onClick={() => onAction('customers')}
                        className={`flex flex-col items-center justify-center ${themeClasses.bgSoft} ${themeClasses.bgSoftHover} p-6 rounded-3xl transition-all active:scale-95 group shadow-sm hover:shadow-md`}
                    >
                        <div className={`w-14 h-14 ${themeClasses.bg} text-white rounded-2xl flex items-center justify-center mb-3 shadow-lg ${themeClasses.shadow} group-hover:rotate-12 transition-transform`}>
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" /></svg>
                        </div>
                        <span className={`font-bold ${themeClasses.textDark} text-sm mt-2`}>New Sale</span>
                    </button>
                    ...
                    <button
                        ...
                        className="flex flex-col items-center justify-center bg-emerald-50 hover:bg-emerald-100 p-6 rounded-3xl transition-all active:scale-95 group shadow-sm hover:shadow-md"
                    >
                        <div className="w-14 h-14 bg-emerald-600 text-white rounded-2xl flex items-center justify-center mb-3 shadow-lg shadow-emerald-200 group-hover:-rotate-12 transition-transform">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                        </div>
                        <span className="font-bold text-emerald-900 text-sm mt-2">Stock Check</span>
                    </button>
                    ...
                    <button
                        ...
                        className="flex flex-col items-center justify-center bg-amber-50 hover:bg-amber-100 p-6 rounded-3xl transition-all active:scale-95 group shadow-sm hover:shadow-md"
                    >
                        <div className="w-14 h-14 bg-amber-500 text-white rounded-2xl flex items-center justify-center mb-3 shadow-lg shadow-amber-200 group-hover:scale-110 transition-transform">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                        </div>
                        <span className="font-bold text-amber-900 text-sm mt-2">Cloud Sync</span>
                    </button>

                    <button
                        onClick={() => onAction('reports')}
                        className="flex flex-col items-center justify-center bg-rose-50 hover:bg-rose-100 p-6 rounded-3xl transition-all active:scale-95 group shadow-sm hover:shadow-md"
                    >
                        <div className="w-14 h-14 bg-rose-500 text-white rounded-2xl flex items-center justify-center mb-3 shadow-lg shadow-rose-200 group-hover:rotate-12 transition-transform">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>
                        </div>
                        <span className="font-bold text-rose-900 text-sm mt-2">Reports</span>
                    </button>
                </div>
            </div>
                        ...
                        <AreaChart data={trendData}>
                            ...
                            <Tooltip
                                contentStyle={{ 
                                    ...
                                    borderRadius: '12px', 
                                    border: `1px solid ${themeClasses.hex}`,
                                    boxShadow: '0 10px 15px -3px rgba(0, 0, 0, 0.1)',
                                    color: '#1e293b'
                                }}
                                itemStyle={{ color: '#1e293b', fontWeight: 'bold', fontSize: '13px' }}
                                labelStyle={{ color: '#64748b', fontSize: '11px', fontWeight: 'bold', marginBottom: '4px', textTransform: 'uppercase' }}
                                    ...
                                    <div className="p-4 flex justify-between items-center hover:bg-slate-50 transition-colors">
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-0.5">
                                                <span className={`text-[10px] font-black ${themeClasses.text} uppercase ${themeClasses.bgSoft} px-1.5 py-0.5 rounded`}>{cleanText(item.vehicle_model)}</span>
