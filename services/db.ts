...
class LocalDB {
  ...
  async autoResolveConflictsAndSync(): Promise<void> {
      ...
      const resolutions = conflictResult.conflicts.reduce((acc: { [id: string]: 'local' | 'cloud' }, conflict) => {
